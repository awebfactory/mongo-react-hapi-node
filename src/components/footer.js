      ...
      <footer>
        ...
        <div className="container-fluid">
          ...
          <p className="pull-right">
            ...
            <a className="sn sn-gh" href="https://github.com/awebfactory/state-shape-designer" target="_blank"><span className="mega-octicon octicon-mark-github" width="32" height="32" /></a>
          </p>
        </div>
        </div>
      </footer>
